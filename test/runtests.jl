...
# !!! Main.UserApp is configured as an alias for Main.MyAPI and you might encounter it in some tests
using Main.MyAPI, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "MyAPI tests" begin
  @includetests ARGS
end
